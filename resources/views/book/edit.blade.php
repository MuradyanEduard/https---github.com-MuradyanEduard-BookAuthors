                    ...
                    <form action="{{ route('book.update',$book->id) }}" method="POST">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <input type="submit" value="Change Book" style="background: #4bb1b1; color: white; height: 40px; margin-top: 15px; font-weight: 500; width: 250px; border-radius: 8px; outline: none!important; border: none; cursor:pointer;">
                                </div>
                            </div>
                        </div>
                    </form>
